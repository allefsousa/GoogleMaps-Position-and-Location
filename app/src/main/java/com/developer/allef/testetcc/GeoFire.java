...
public class GeoFire extends FragmentActivity implements GeoQueryEventListener,GoogleMap.OnCameraChangeListener{

DatabaseReference data = FirebaseDatabase.getInstance().getReference().child("ruas").child("Jose martins");
    ...
    private com.firebase.geofire.GeoFire geoFire;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.geoFire = new com.firebase.geofire.GeoFire(data);
        // radius in km
